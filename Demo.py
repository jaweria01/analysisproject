...
with col1:
    with st.expander("Show Dataset Head".style.background_gradient(cmap="Blues")):
...
with col3:
    with st.expander("Show Dataset Info".style.background_gradient(cmap="Blues")):
...
with col4:
    with st.expander("Show DataSet Shape".style.background_gradient(cmap="Blues")):
