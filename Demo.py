...
with col1:
    if styled_button("Show Dataset Head", "btn_head", button_color='blue', text_color='white'):
        st.subheader("First 5 Rows of the Dataset")
        st.write(df.head())
with col2:
    if styled_button("Show Dataset Tail", "btn_tail", button_color='blue', text_color='white'):
        st.subheader("Last 5 Rows of the Dataset")
        st.write(df.tail())

col3, col4 = st.columns((2))
with col3:
    if styled_button("Show Dataset Info", "btn_info", button_color='blue', text_color='white'):
        ...
        st.text(s)
with col4:
    if styled_button("Show DataSet Shape", "btn_shape", button_color='blue', text_color='white'):
        st.subheader("Dataset Shape")
        st.write(f"Rows: {df.shape[0]}, Columns: {df.shape[1]}")

col5, col6 = st.columns((2))
with col5:
    if styled_button("Show Dataset Columns", "btn_columns", button_color='blue', text_color='white'):
        st.subheader("Dataset Columns")
        st.write(df.columns.tolist())

with col6:
    if styled_button("Show Null Values", "btn_nulls", button_color='blue', text_color='white'):
...
with col7:
    if styled_button("Fill Missing Values", "btn_fill_missing", button_color='blue', text_color='white'):
...
with col8:
    if styled_button("Show Updated Info", "btn_updated_info", button_color='blue', text_color='white'):
...
with col9:
    if styled_button("Show DS Description", "btn_describe", button_color='blue', text_color='white'):
        st.subheader("Statistical Summary")
        st.write(df.describe().T)
with col10:       
    if styled_button("Check DS Duplicates", "btn_duplicates", button_color='blue', text_color='white'):
...
with col11:
    if styled_button("Find Outliers (Z-score)", "btn_zscore_outliers", button_color='blue', text_color='white'):
...
with col12:
    if styled_button("Find Outliers (IQR)", "btn_iqr_outliers", button_color='blue', text_color='white'):
        numeric_cols = df.select_dtypes(include=[np.number]).columns
        outliers = {}
        for col in numeric_cols:
