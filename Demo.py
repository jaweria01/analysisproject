...
with col1:
    with st.expander("Show Dataset Head"):
        st.markdown("<h3 style='text-align: left; color: blue;'>First 5 Rows of the Dataset</h3>", unsafe_allow_html=True)
        st.write(df.head().style.background_gradient(cmap="Blues"))
with col2:
    with st.expander("Show Dataset Tail"):
        st.markdown("<h3 style='text-align: left; color: blue;'>Last 5 Rows of the Dataset</h3>", unsafe_allow_html=True)
        st.write(df.tail().style.applymap(lambda _: 'background-color: lightblue'))

col3, col4 = st.columns((2))
with col3:
    with st.expander("Show Dataset Info"):
        st.markdown("<h3 style='text-align: left; color: blue;'>Dataset Information</h3>", unsafe_allow_html=True)
        buffer = io.StringIO()
        df.info(buf=buffer)
        s = buffer.getvalue()
        st.text(s)
with col4:
    with st.expander("Show DataSet Shape"):
        st.markdown("<h3 style='text-align: left; color: blue;'>Dataset Shape</h3>", unsafe_allow_html=True)
...
with col6:
    with st.expander("Show Null Values"):
        st.markdown("<h3 style='text-align: left; color: blue;'>Missing Values in the Dataset</h3>", unsafe_allow_html=True)
...
with col8:
    with st.expander("Show Updated Info"):
        st.markdown("<h3 style='text-align: left; color: blue;'>Updated Dataset Information</h3>", unsafe_allow_html=True)
        buffer = io.StringIO()
        df.info(buf=buffer)
        s = buffer.getvalue()
        st.text(s)
...
with col9:
    ...
    with st.expander("Show DS Description"):
        st.markdown("<h3 style='text-align: left; color: blue;'>Statistical Summery</h3>", unsafe_allow_html=True)
...
with col11:
    ...
    with st.expander("Find Outliers (Z-score)"):
        ...
        st.markdown("<h3 style='text-align: left; color: blue;'>Outliers Detected using Z-score</h3>", unsafe_allow_html=True)
...
with col12:
    with st.expander("Find Outliers (IQR)"):
        ...
        st.markdown("<h3 style='text-align: left; color: blue;'>Outliers Detected using IQR</h3>", unsafe_allow_html=True)
