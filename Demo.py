...
with col1:
    if styled_button("Show Dataset Head", "btn_head"):
        st.subheader("First 5 Rows of the Dataset")
        st.write(df.head())
with col2:
    if styled_button("Show Dataset Tail", "btn_tail"):
        st.subheader("Last 5 Rows of the Dataset")
        st.write(df.tail())

col3, col4 = st.columns((2))
with col3:
    if styled_button("Show Dataset Info", "btn_info"):
        ...
        st.text(s)
with col4:
    if styled_button("Show DataSet Shape", "btn_shape"):
        st.subheader("Dataset Shape")
        st.write(f"Rows: {df.shape[0]}, Columns: {df.shape[1]}")

col5, col6 = st.columns((2))
with col5:
    if styled_button("Show Dataset Columns", "btn_columns"):
...
with col7:
    if styled_button("Fill Missing Values", "btn_fill_missing"):
